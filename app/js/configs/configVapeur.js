...
feats: [
        {id: 'expertiseCombat', name: 'Expertise de combat', description: 'blabla'}
        ],
...
skillGroups: [
                   {id: 'athlete', name: 'athlete', skills: ['compAcrobatie',
                                                               'compEquilibre',
                                                               'compEscalade',
                                                               'compSaut']},
                   {id: 'infiltrateur', name: 'infiltrateur', skills: ['compDiscretion', 
                                                                         'compMouvementSilencieux',
                                                                         'compCrochetage',
                                                                         'compDesamorcage']},
                   {id: 'fouineur', name: 'fouineur', skills: ['compFouille',
                                                                 'compContrefacon',
                                                                 'compEstimation',
                                                                 'compRenseignement']},
                   {id: 'saltimbanque', name: 'saltimbanque', skills: ['compEvasion',
                                                                         'compMaitriseCordes',
                                                                         'compRepresentation',
                                                                         'compEscamotage']},
                   {id: 'chevalier', name: 'chevalier', skills: ['compDressage',
                                                                   'compIntimidation',
                                                                   'compEquitation',
                                                                   'compNatation']},
                   {id: 'negociateur', name: 'negociateur', skills: ['compDiplomatie', 
                                                                       'compBluff', 
                                                                       'compPsycho', 
                                                                       'compDeguisement']},
                   {id: 'sentinelle', name: 'sentinelle', skills: ['compDetection',
                                                                     'compPerceptionAuditive',
                                                                     'compConcentration',
                                                                     'compPremierSecours']},
                   {id: 'savant', name: 'savant', skills: ['compConnaissance',
                                                             'compConnaissance',
                                                             'compConnaissance',
                                                             'compConnaissance',
                                                             'compConnaissance'], multiple: true}
                   ],
...
skills: [
              ...
              {id: 'compDiscretion', name: 'Discr�tion', ability: 'dex'},
